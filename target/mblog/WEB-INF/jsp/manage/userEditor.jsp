        ...
        <div class="card-panel">
            <form id="loginForm" method="post" action="/manage/user/save/${user.userId}" onsubmit="return check()">
                ...
                <div class="input-field col s6">
                    ...
                    <select id="userImageId" name="userImageId" class="icons">
                        <option value="" disabled selected>头像</option>
                        <c:forEach var="userImage" items="${userImages}">
                            <option value="${userImage.imageId}" data-icon="../../images/user/${userImage.imageName}" class="circle"
                                ${user.imageId==userImage.imageId?'selected':'' }>${userImage.imageName}</option>
                        </c:forEach>
                    </select>
                </div>
                <br><br><br><br>
